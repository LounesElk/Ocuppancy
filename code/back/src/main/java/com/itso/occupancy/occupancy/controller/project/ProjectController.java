...
public class ProjectController {
    ...
    @GetMapping("/user/{id}")
    @PreAuthorize("hasPermission(returnObject, 'export')")
    public ResponseEntity<ProjectUserDto> getProjectsAndUser(@PathVariable Long id) { //Récupère un projects avec les utilisateurs concernés et la temps pour le project
